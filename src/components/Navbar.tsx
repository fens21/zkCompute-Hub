                  ...
                  {!connected ? (
                    ...
                    <>
                      <div ref={walletMenuRef} style={{ position: 'relative' }}>
                        ...
                        {showWalletMenu && (
                          <div role="menu" aria-label="Wallet menu" style={{ position: 'absolute', right: 0, top: '100%', marginTop: 4, background: colors.bgElevated, border: `1px solid ${colors.borderLight}`, borderRadius: radii.md, zIndex: 100, overflow: 'hidden', minWidth: 'max-content' }}>
