...
function AppContent() {
  ...
  return (
    <div className="app-container">
      ...
      <footer className="lp-footer" style={{ padding: '24px 24px 16px', flexShrink: 0 }}>
        <div className="lp-footer-inner" style={{ gap: 8 }}>
          <div style={{ fontSize: fontSizes.md, fontWeight: 700, color: colors.gold }}>zkCompute Hub</div>
          <div style={{ fontSize: fontSizes.xs, color: 'rgba(197, 193, 192, 0.85)' }}>Decentralized verifiable compute on LitVM</div>
        ...
        <div className="lp-footer-bottom" style={{ padding: '8px 0', marginTop: 8 }}>
          LitVM &bull; Litecoin's Virtual Machine &bull; Hard Money Web3
          <div style={{ marginTop: 8, fontSize: 10, color: 'rgba(197, 193, 192, 0.8)' }}>
            © {new Date().getFullYear()} zkCompute Hub. All rights reserved. &bull; Testnet only &bull; Not financial advice
          </div>
        </div>
      </footer>
